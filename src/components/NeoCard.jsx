          ...
          <div className="flex items-start space-x-3">
            {showCheckbox && (
              <input
                ...
                className="mt-1 h-4 w-4 text-cosmic-purple bg-white/10 border-white/30 rounded focus:ring-cosmic-purple focus:ring-2"
              />
            )}
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-gray-400">
              {closeApproach.miss_distance?.lunar ? 
                `${parseFloat(closeApproach.miss_distance.lunar).toFixed(1)} LD` : 
                ''
              }
            </span>
          </div>
